...
const headSetDetectionPlugin: HeadsetDetectionPlugin = Plugins.HeadsetDetection as HeadsetDetectionPlugin;
...
export class HomePage {
  ...
  public readonly isConnected$: Observable<boolean> = this.isConnected$$
  .pipe(
    debounceTime(300),
  ...
  public readonly headsets$: Observable<HeadsetDevice | null> = this.headsets$$
    .pipe(
      debounceTime(300),
